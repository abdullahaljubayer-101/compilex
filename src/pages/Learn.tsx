            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-400 mt-2">
                  Master programming with our structured courses and tutorials
                </p>
              </div>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    42% of Front-end Path completed
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-center">
                <div className="flex flex-col">
                  <div className="w-full bg-compliex-gray-dark rounded-full h-2.5">
                    <div
                      className="bg-compliex-red h-2.5 rounded-full"
                      style={{ width: "42%" }}
                    ></div>
                  </div>
                ...
                <Button className="bg-compliex-red hover:bg-compliex-red-dark">
                  Continue
                </Button>
              </div>
            </div>
            ...
            <TabsContent value="saved">
              <div className="min-h-[300px] flex items-center justify-center flex-col text-center">
                ...
                <p className="text-gray-400 mt-2 max-w-md">
                  When you save courses or tutorials, they'll appear here for
                  easy access
                </p>
                <Button
                  variant="outline"
                  className="mt-4 border-compliex-gray-dark"
                >
                  Browse Courses
                </Button>
              </div>
    ...
    <Card className="bg-compliex-dark-lighter border-compliex-gray-dark hover:border-compliex-red/50 transition-all">
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start">
          <div className="feature-icon">{path.icon}</div>
          <Badge
            variant="outline"
            className="border-compliex-gray-light text-gray-300"
          >
            {path.level}
          </Badge>
        </div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            <Avatar className="h-6 w-6">
              <AvatarImage
                src={course.authorAvatar || "https://github.com/shadcn.png"}
              />
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          {course.tags.map((tag, index) => (
            <Badge
              key={index}
              variant="secondary"
              className="bg-compliex-gray-dark text-gray-300"
            >
              {tag}
            </Badge>
          ))}
        ...
        {course.progressPercent !== undefined && (
          <div className="w-full">
            ...
            <div className="flex justify-between">
              <Button
                variant="link"
                className="text-compliex-red p-0 h-auto text-xs"
              >
                Continue
              </Button>
              <span className="text-xs text-gray-400">
...
const learningPaths: LearningPath[] = [
  {
    ...
    description:
      "Master HTML, CSS, JavaScript and popular frameworks to build modern web interfaces.",
    modules: 42,
    hours: 85,
    level: "Beginner",
  ...
  },
  {
    ...
    description:
      "Learn server-side programming, databases, and APIs to power web applications.",
    modules: 38,
    hours: 78,
    level: "Intermediate",
  ...
  },
  {
    ...
    description:
      "Combine front-end and back-end skills to build complete web applications.",
    modules: 65,
    hours: 130,
    level: "Advanced",
...
const tutorials: Tutorial[] = [
  {
    ...
    description:
      "Learn how to create a RESTful API using Node.js, Express, and MongoDB to power your web applications.",
    readTime: "15 min",
    date: "May 8, 2025",
  ...
  },
  {
    ...
    description:
      "Master CSS Grid Layout to create complex, responsive web layouts with less code and more flexibility.",
    readTime: "12 min",
    date: "May 6, 2025",
  ...
  },
  {
    ...
    description:
      "Dive deep into JavaScript closures, how they work, and how to use them effectively in your code.",
    readTime: "10 min",
    date: "May 5, 2025",
  ...
  },
  {
    ...
    description:
      "Learn efficient Git workflows for collaboration in development teams, including branching strategies and code reviews.",
    readTime: "18 min",
    date: "May 4, 2025",
  ...
  },
  {
    ...
    description:
      "Set up continuous deployment for React applications using GitHub Actions to automate your build and deployment process.",
    readTime: "14 min",
    date: "May 2, 2025",
  ...
  },
  {
    ...
    description:
      "Create inclusive, accessible web forms that comply with WCAG guidelines and provide a better user experience for all.",
    readTime: "16 min",
    date: "May 1, 2025",
