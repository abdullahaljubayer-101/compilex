...
const challenges: Challenge[] = [
  ...
  },
  {
    ...
    category: "Data Structures",
    description:
      "Create a linked list with add, remove and traverse operations.",
    completedBy: 3241,
    timeEstimate: "25 min",
    xpPoints: 90,
  },
...
const Practice: React.FC = () => {
  ...
  const filteredChallenges = challenges.filter((challenge) => {
    ...
    const matchesDifficulty = activeDifficulty
      ? challenge.difficulty === activeDifficulty
      : true;
      ...
      <div className="container mx-auto px-4 py-24">
        <div className="mb-12 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">
            Practice <span className="text-compliex-red">Coding</span>{" "}
            Challenges
          </h1>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Improve your coding skills with practical challenges. Choose from a
            variety of topics and difficulty levels to level up your programming
            expertise.
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <Avatar className="h-16 w-16 border-2 border-compliex-red">
                ...
                <AvatarFallback className="bg-compliex-dark-lighter text-white">
                  CN
                </AvatarFallback>
              </Avatar>
              <div>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <div className="mr-4 mb-4">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant={
                        activeDifficulty === null ? "default" : "outline"
                      }
                      size="sm"
                      className={
                        activeDifficulty === null
                          ? "bg-compliex-red border-compliex-red"
                          : "text-gray-400"
                      }
            ...
            <TabsContent value="recommended" className="mt-0">
              <div className="text-center py-16 bg-compliex-dark-lighter rounded-lg border border-compliex-gray-dark">
                ...
                <p className="text-gray-400 mb-4 max-w-md mx-auto">
                  Sign in to get challenges recommended based on your skill
                  level and interests.
                </p>
        ...
        <div className="mt-16 bg-compliex-dark-lighter border border-compliex-gray-dark rounded-lg p-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
              <Badge className="mb-2 bg-compliex-red text-white border-none">
                Weekly Challenge
              </Badge>
              ...
              <p className="text-gray-400 mb-4 max-w-xl">
                Solve this week's featured challenge to earn bonus XP and climb
                the leaderboard. This problem focuses on finding the contiguous
